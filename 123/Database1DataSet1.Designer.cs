...
namespace _123 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class messageTableDataTable : global::System.Data.TypedTableBase<messageTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public messageTableRow AddmessageTableRow(int Id, string username, string message) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public messageTableRow FindById(int Id) {
        ...
        public partial class messageTableRow : global::System.Data.DataRow {
            ...
            public int Id {
                get {
                    return ((int)(this[this.tablemessageTable.IdColumn]));
                }
                set {
                    this[this.tablemessageTable.IdColumn] = value;
                }
            }
            ...
            public string username {
                get {
                    try {
                        return ((string)(this[this.tablemessageTable.usernameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'username\' in table \'messageTable\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablemessageTable.usernameColumn] = value;
                }
            }
            ...
            public string message {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'message\' in table \'messageTable\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsusernameNull() {
                return this.IsNull(this.tablemessageTable.usernameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetusernameNull() {
                this[this.tablemessageTable.usernameColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsmessageNull() {
                return this.IsNull(this.tablemessageTable.messageColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetmessageNull() {
                this[this.tablemessageTable.messageColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace _123.Database1DataSet1TableAdapters {
    ...
    public partial class messageTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[messageTable] WHERE (([Id] = @Original_Id) AND ((@IsNull_usern" +
                "ame = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsN" +
                "ull_message = 1 AND [message] IS NULL) OR ([message] = @Original_message)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[messageTable] ([Id], [username], [message]) VALUES (@Id, @user" +
                "name, @message);\r\nSELECT Id, username, message FROM messageTable WHERE (Id = @Id" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[messageTable] SET [Id] = @Id, [username] = @username, [message] = @message WHERE (([Id] = @Original_Id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_message = 1 AND [message] IS NULL) OR ([message] = @Original_message)));
SELECT Id, username, message FROM messageTable WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, username, message FROM dbo.messageTable";
        ...
        public virtual int Fill(Database1DataSet1.messageTableDataTable dataTable) {
        ...
        public virtual Database1DataSet1.messageTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.messageTableDataTable dataTable = new Database1DataSet1.messageTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.messageTableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_username, string Original_message) {
        ...
        public virtual int Update(int Id, string username, string message, int Original_Id, string Original_username, string Original_message) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string message, int Original_Id, string Original_username, string Original_message) {
            return this.Update(Original_Id, username, message, Original_Id, Original_username, Original_message);
        }
    }
